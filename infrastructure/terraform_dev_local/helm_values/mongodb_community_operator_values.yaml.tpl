# Helm values for MongoDB Community Operator, managed by Terraform
# See https://github.com/mongodb/helm-charts/blob/main/charts/community-operator/values.yaml

# Deploys the MongoDB Community Operator.
operator:
...
community-operator-crds:
  enabled: ${community_operator_crds_enabled}
...
resource:
  ...
  users:
    - name: root
      db: admin
      # Reference the secret created separately by Terraform
      passwordSecretRef:

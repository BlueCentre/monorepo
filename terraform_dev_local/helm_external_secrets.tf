...
resource "helm_release" "external_secrets" {
  ...
  values = [
    templatefile(
      ...
      {
        # gcpCommonProjectID     = "prj-flyr-com-secrets-665b", # data.org.outputs.org_secrets_project_id,
...
#   provider:
#     gcpsm:
#       projectID: "prj-flyr-com-secrets-665b"
# EOF
#   depends_on = [helm_release.external_secrets]
# }
...
#   source               = "app.terraform.io/flyrlabs/secret/google//modules/accessor"
#   version              = "1.0.0"
#   environment          = "com"
#   tenant               = "flyr"
...
#   count    = var.config_cluster ? 1 : 0
#   group_id = "r_datadog_api_key_secret_accessor_org@flyrlabs.net"
#   email    = module.external_secrets_workload_identity[0].gcp_service_account_email
#   role     = "MEMBER"
# }


# https://github.com/FlyrInc/ooms-sharedcomponents/blob/main/kustomize/components/external-secrets/clustersecretstore.yaml
# https://external-secrets.io/latest/provider/google-secrets-manager/

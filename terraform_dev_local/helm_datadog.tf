...
#   project  = "prj-flyr-com-secrets-665b" #TODO hard code this, or keep simple?
# }

# https://app.datadoghq.com/infrastructure?netviz=sent_vol%3A%3A%2Ctcp_r_pct%3A%3A%2Crtt%3A%3A&tab=agent-configuration&tags=flyr_owner%3Aplatform&text=flyr_tenant%3Ademo
...
resource "helm_release" "datadog_agent" {
  ...
  # #    name  = "agents.nodeSelector.flyr_datadog"
  # #    value = "monitored"
  # #  }
  ...
  # set {
  #   name  = "datadog.tags"
  #   value = "env:${var.environment} flyr_tenant:${var.tenant}"
  # }

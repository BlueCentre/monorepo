...
# https://github.com/FlyrInc/ooms-sharedcomponents/blob/main/kustomize/components/external-dns/secret.yaml
# https://github.com/FlyrInc/ooms-sharedcomponents/blob/main/kustomize/tenants/rx/testing/httproute-api-patch.yaml

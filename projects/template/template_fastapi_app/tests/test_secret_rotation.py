...
class SecretRotationManager:
    ...
    def _initialize_keys(self):
        ...
        jwt_key = {
            ...
            "expires_at": (datetime.utcnow() + timedelta(days=self.key_lifetime_days)).isoformat()
        }
    ...
    def _save_to_file(self):
        ...
        data = {
            JWT_KEY_TYPE: self.jwt_keys,
            DB_CREDENTIAL_TYPE: self.db_credentials
        }
    ...
    def get_current_db_credentials(self):
        ...
        if not self.enabled or not self.db_credentials:
            return {"username": self.initial_db_username, "password": self.initial_db_password}
        return {"username": self.db_credentials[0]["username"], "password": self.db_credentials[0]["password"]}
    ...
    def get_all_keys_status(self):
        ...
        return {
            ...
            "db_credentials": db_creds_status
        }

...
ITEM_TITLES = [
    "Productivity Tool", "Development Framework", "Cloud Service",
    "Machine Learning Library", "Mobile Application", "Data Visualization Tool",
    "Database Solution", "API Service", "Security Software", "IoT Platform"
]

NOTE_TITLES = [
    "Meeting Notes", "Project Ideas", "API Documentation", "Design Patterns",
    "Research Findings", "Implementation Strategy", "User Feedback", "Performance Metrics",
    "Team Updates", "Development Roadmap"
]

ADJECTIVES = [
    "innovative", "powerful", "efficient", "scalable", "robust",
    "intuitive", "seamless", "secure", "flexible", "advanced"
]

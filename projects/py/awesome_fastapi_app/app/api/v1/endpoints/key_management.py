...
def get_key_status(current_user=Depends(deps.get_current_active_superuser)) -> Any:
    """
...
def rotate_jwt_key(current_user=Depends(deps.get_current_active_superuser)) -> Any:
    """
